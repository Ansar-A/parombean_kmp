...
<div class="az-signup-wrapper">
      ...
      <div class="az-column-signup">
        <h1 class="az-logo">Login Admin</h1>
        <div class="az-signup-header">
          ...
          <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>
            ...
            <div class="form-group d-flex justify-content-between align-items-center">
                    ...
                    <br>
                    <?= Html::a('Verification email?', ['site/resend-verification-email']) ?>
                </div>
               <div class="form-group">
                    <?= Html::submitButton('Sign In', ['class' => 'btn btn-az-primary btn-block', 'name' => 'login-button']) ?>
                </div> 
        ...
        <div class="az-signup-footer">
          <p>Don't have an account? <a href="<?=Url::to(['signup'])?>">Create an Account to Admin</a></p>
